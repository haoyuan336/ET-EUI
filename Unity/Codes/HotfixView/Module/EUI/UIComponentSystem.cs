...
namespace ET
{
    ...
    public static class UIComponentSystem
    {
        ...
        public static async ETTask ShowWindowAsync(this UIComponent self, WindowID id, WindowID preWindowID = WindowID.WindowID_Invaild,
        ShowWindowData showData = null)
        {
            try
            {
        ...
        public static async ETTask ShowWindowAsync<T>(this UIComponent self, WindowID preWindowID = WindowID.WindowID_Invaild,
        ShowWindowData showData = null) where T : Entity
        {
            WindowID windowsId = self.GetWindowIdByGeneric<T>();
