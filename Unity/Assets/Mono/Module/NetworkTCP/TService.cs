...
namespace ET
{
    public sealed class TService: AService
    {
        ...
        public TService(ThreadSynchronizationContext threadSynchronizationContext, IPEndPoint ipEndPoint, ServiceType serviceType)
        {
            ...
            // Log.Error($"ip end point {ipEndPoint}");
            // ipEndPoint = "172.29.230.210:20001";
            Log.Warning($"ip end point {ipEndPoint}");

            // ipEndPoint = new IPEndPoint(IPAddress.Parse("59.110.220.207"), ipEndPoint.Port);
            // Log.Warning($"ip end point {ipEndPoint}");
