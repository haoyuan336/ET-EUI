...
{
    unsafe class ET_ETTask_1_SceneInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.ETTask<UnityEngine.ResourceManagement.ResourceProviders.SceneInstance>);
            args = new Type[]{};
        ...
        static StackObject* Create_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.ETTask<UnityEngine.ResourceManagement.ResourceProviders.SceneInstance>.Create(@fromPool);
