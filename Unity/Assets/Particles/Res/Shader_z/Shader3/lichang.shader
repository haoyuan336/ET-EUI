...
////// Emissive:
                ...
                float2 node_4773 = (i.uv0+node_3511.g*float2(0.2,-0.1));
                float4 _node_5765_var = tex2D(_node_5765,TRANSFORM_TEX(node_4773, _node_5765));
                float2 node_4990 = (i.uv0+node_3511.g*float2(-0.1,0.2));
                float4 _node_9042_var = tex2D(_node_9042,TRANSFORM_TEX(node_4990, _node_9042));
                float2 node_3041 = ((i.uv0+node_3511.g*float2(0.1,0))+(_node_5765_var.r*_node_9042_var.r*0.3));
